...
const EditCustomizer = ({
  ...
  const [openEditProductOverlay, setOpenEditProductOverlay] = useState(false)
  ...
  return (
    <>
      ...
      <EditProduct
        openEditProductOverlay={openEditProductOverlay}
        setOpenEditProductOverlay={setOpenEditProductOverlay}
        id={id}
        name={name}
        setName={setName}
        size={size}
