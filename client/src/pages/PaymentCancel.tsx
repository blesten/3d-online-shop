    ...
    <>
      ...
      <div className='w-screen h-screen overflow-hidden px-14 py-8 flex flex-col justify-center'>
        ...
        <div className='flex items-center justify-center flex-col'>
          ...
          <p className='text-xs text-neutral-700 text-center mt-4'>It seems like the payment process is being interrupted. Please try again to checkout.</p>
          <Button
            text='Home'
